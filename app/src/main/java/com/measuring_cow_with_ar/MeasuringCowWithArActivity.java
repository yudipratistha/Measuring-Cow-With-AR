...
public class MeasuringCowWithArActivity extends AppCompatActivity{
    private static final String TAG = MeasuringCowWithArActivity.class.getSimpleName();
...
//        pressedTime = System.currentTimeMillis();
    ...
    private MeasuringCowWithArActivity.GLSurfaceRenderer glSerfaceRenderer = null;
...
//                popUp.showAsDropDown(v, 0, 0); // show popup like dropdown list
    ...
    private void setupRenderer(){
        ...
        glSerfaceRenderer = new MeasuringCowWithArActivity.GLSurfaceRenderer(this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                messageSnackbar = Snackbar.make(
                        MeasuringCowWithArActivity.this.findViewById(android.R.id.content),
...
//            log(TAG, "onDrawFrame(), mTouches.size=" + mTouches.size());
            ...
            try {
                ...
                MeasuringCowWithArActivity.this.pointCloud.update(pointCloud);
                MeasuringCowWithArActivity.this.pointCloud.draw(viewmtx, projmtx);
